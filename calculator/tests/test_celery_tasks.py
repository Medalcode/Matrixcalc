...
class TestExportBackupTask:
    ...
    def test_failure_raises_exception(self):
        ...
        with (
            ...
            pytest.raises(Exception, match="export_backup failed: disk full"),
        ):
            export_backup_task()
...
class TestCleanupOldDataTask:
    ...
    def test_success_returns_result(self):
        ...
        with mock.patch(
            "calculator.celery_tasks.cleanup_data_service", return_value={"status": "ok"}
        ):
    ...
    def test_failure_raises_exception(self):
        ...
        with (
            ...
            pytest.raises(Exception, match="cleanup_old_data failed: permission denied"),
        ):
